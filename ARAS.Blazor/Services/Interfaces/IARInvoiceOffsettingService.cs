...
namespace ARAS.Blazor.Services.Interfaces
{
    public interface IARInvoiceOffsettingService
    {
        ...
        Task Update(bool isUpdatable, long requestId, IEnumerable<ARInvoiceOffsettingRowDto> arRows, IEnumerable<ARInvoiceOffsettingRowDto> cnRows, IEnumerable<NoteRowDto> notes);
